...
If the User selects to delete all entries stored a function is ran for this. The User will be asked to confirm that they want to delete all data and if they select yes then all three worksheets are looped through and all entries are cleared leavin a blank database.
